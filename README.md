...
```bash
pip install \
  -c https://raw.githubusercontent.com/dperezcabrera/pico-bom/main/2026.07.txt \
...
| Train | Highlights |
|---|---|
| [2026.07](2026.07.txt) | pico-ioc 2.3.3 (idempotent shutdown), pico-testing 0.2.0 fleet-wide, sqlalchemy 0.5.1 (ASGI-safe DDL hooks), PyJWT auth pair |
